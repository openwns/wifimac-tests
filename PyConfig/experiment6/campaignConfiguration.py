...
# begin example "wifimac.tutorial.experiment6.db.campaignConfiguration.import"
...
# begin example "wifimac.tutorial.experiment6.db.campaignConfiguration.Set"
class Set(AutoSimulationParameters):
    # scenario parameters
    simTime = Float(parameterRange = [5.0])
    numHops = Int(parameterRange = [2, 3])
    distance = Int(parameterRange = [50])
...
# begin example "wifimac.tutorial.experiment6.db.campaignConfiguration.GetTotalThroughput"
...
# begin example "wifimac.tutorial.experiment6.db.campaignConfiguration.Cursor"
...
# begin example "wifimac.tutorial.experiment6.db.campaignConfiguration.params"
...
# begin example "wifimac.tutorial.experiment6.db.campaignConfiguration.CreateNew"
